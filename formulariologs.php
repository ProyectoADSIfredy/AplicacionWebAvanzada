                        ...
                        <li class="message-preview">
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <!-- <h5 class="media-heading"><strong>Fre</strong>
                                        </h5> -->
                                        <p class="small text-muted"><i class="fa fa-clock-o"></i> Yesterday at 4:32 PM</p>
                                        <p>Lorem ipsum dolor sit amet, consectetur...</p>
                                    </div>
                    ...
                    <div class="col-lg-6">
                        <form role="form" action="include/registropost.php" method="post">
                            ...
                            <div class="form-group">
                                Titulo
                                <input class="form-control" type="text" name="titulo"autofocus required>
                            </div>
                            ...
                            <div class="form-group">
                                Icono
                                <input class="form-control" type="text" name="icono"required>
                            </div>

                            <div class="form-group">
                                Texto
                                <textarea class="form-control" rows="4" name="texto" maxlength="4000"></textarea><br/>
                             <input type="submit">
                            </div>
