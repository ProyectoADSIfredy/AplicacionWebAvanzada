        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="inicio.php"><i class="fa fa-fw fa-dashboard"></i>Mis Blogs</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <!-- AQUI VA EL DIV DE LA FOTO  -->
                        <div class="mifoto"><img src="images/<?php echo $_SESSION['foto']?>.jpeg" height="150px" width="150px"></div>
                         <br/>
                        </div>
                <!-- <div class="row">
                    <div class="col-lg-12">
